...
import {
  revalidateDelete,
  revalidateIngredientCategory,
} from './hooks/revalidateIngredientCategory'
...
export const IngredientCategories: CollectionConfig<'ingredientCategories'> = {
  ...
  defaultPopulate: {
    title: true,
    slug: true,
    relatedIngredientCategories: true,
    meta: {
      image: true,
      description: true,
    },
    ...
    },
    {
      ...
      tabs: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'relatedIngredientCategories',
              type: 'relationship',
              admin: {
                position: 'sidebar',
              },
  ...
  hooks: {
    afterChange: [revalidateIngredientCategory],
